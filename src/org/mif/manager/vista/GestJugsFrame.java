...
public class GestJugsFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sexeComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Masculí", "Femení" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestJugsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestJugsFrame().setVisible(true);
            }
        });
    }
